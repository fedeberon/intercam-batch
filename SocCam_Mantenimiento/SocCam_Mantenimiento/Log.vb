...
Public Class Log
    ...
    Public Sub SetError(ByVal ex As Exception, ByVal subSystem As String, ByVal functionName As String, Optional ByVal debugMessage As String = "")
        ...
        _LogFilePath = _LogFilePath & $"{Utils.DateTo8601(Now.Date)}-syslog.log"
    ...
    Public Sub SetError(ByVal errorDescription As String, ByVal subSystem As String, ByVal functionName As String)
        ' TODO: Corregir niveles de rror
        _Timestamp = Now
        _SubSystem = subSystem
        _ModuleName = functionName
